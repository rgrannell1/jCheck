...
/*
	shouldContinue :: [number] -> boolean

	test, based on the rate of score change,
	whether the genetic algorithm should keep
	iterating.
*/
...
/*
	...
	A generalised genetic algorithm. Takes an initial
	scoring function, a mutating function, and a
	scoring function, and returns an optimal value.
*/
...
/*
	shrinkFail :: (a -> boolean) -> (a -> boolean) -> [a] -> a
