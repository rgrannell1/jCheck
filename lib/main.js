...
const runTest = function (test, groups, state, testcase, info) {
...
/*
	this function checks if 'this' is the global namespace.
*/

const isGlobalThis = function (context) {
	return context.GLOBAL || context.window
}
