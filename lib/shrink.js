...
const substitute = function (val) {
	return getMethod(_substituteCategory, _substitute, val)(val)
}
...
const mutate = function (coll) {
	...
	const mutators = [remove, substitute]
...
const GA = function (pop, mutate, score) {
	...
	/*
		use an initial pop for better initial variation.
	*/
